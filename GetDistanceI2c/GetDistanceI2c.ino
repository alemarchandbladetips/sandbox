...
//  temps = micros();
 ...
 // Serial.println(myLidarLite.distance());
  ...
  { 
    ...
    //Altitude = myLidarLite.distance()*10;
    
    ptr_data_uint16 = (uint8_t *) &Altitude;
    
    Serial1.write(137);
    Serial1.write( *ptr_data_uint16 );
    Serial1.write( *(ptr_data_uint16+1) );
    Serial1.write(173);
    Serial.println("a");

    //Serial.println(myLidarLite.distance()/100.0);

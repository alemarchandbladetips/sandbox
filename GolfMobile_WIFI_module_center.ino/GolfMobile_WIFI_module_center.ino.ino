  ...
  if(client_connected_flag)
  {
    ...
    if (packetSize)
    {
      ...
      if(packetSize==6 && incomingPacket[0] == WIFI_START1 && incomingPacket[1] == WIFI_START2)
      {
        ...
        Serial.write(WIFI_START1);//Serial.print("\t");
        Serial.write(WIFI_START2);//Serial.print("\t");
        Serial.write(joyX);//Serial.print("\t");
        Serial.write(joyY);//Serial.print("\t");
        Serial.write(button_cruise);//Serial.print("\t");
        Serial.write(button_brake);//Serial.print("\t");
        //Serial.write("\t");
        timer = micros();

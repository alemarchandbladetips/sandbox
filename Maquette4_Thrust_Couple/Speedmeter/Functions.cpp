...
void RxTxSerial:: begin(int baudrate)
{
...
void print(int nb, String str[], float val[], char *term )
{
  ...
  {
    Serial.print(str[i]);Serial.print("\t");
    Serial.print(val[i]);Serial.print("\t");
  }
  Serial.print(str[nb-1]);Serial.print("\t");
  Serial.print(val[nb-1]);Serial.print(term);
}
...
{
  Serial.print(str1);Serial.print(sep);
  Serial.print(val1);Serial.print(term);
}

void print(char *str1, char *str2, float val1, float val2, char *term, char *sep = "\t")
{
  print(str1, val1, sep, sep);
  print(str2, val2, term, sep);
}
void print(char *str1, char *str2, char *str3, float val1, float val2, float val3, char *term , char *sep = "\t")
{
   print(str1, str2, val1, val2, sep, sep);
   print(str3,val3, term, sep);
}

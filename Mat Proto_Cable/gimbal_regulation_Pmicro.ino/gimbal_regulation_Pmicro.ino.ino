...
float motor_speed_rps_ = -6; // desired speed of the motor, rps
float motor_speed_rps_step = -0.002;
...
//
//    Serial.print(sinAngleA); Serial.write(9);
//    Serial.print(normalized_angle); Serial.write(9);
//    Serial.println(angle_rd);

...
// Pre-computation of variables for 
  ...
  slice_angle_rd = 2.0*pi/(nb_pole/2.0);
  angle_scale_factor = sineArraySize/slice_angle_rd;
  Serial.println(slice_angle_rd*360.0/two_pi);
...
/////////////////////////////////////////////////////////////////////
// Interruption routine @1000Hz using Timer 3
// integration of motor angle with the step computed in command
// + counters to replace millis()
...
int i,j,x;
    ...
    // Applying the command if new, will be done all along the program
...
//////////// Computing command ////////////////////
          ...
          { 
            ...
            // computing the PI correction
            u = constrain(u_proportionel + u_integral,-U_MAX,U_MAX); 
...
//////////// transmision to main board ////////////////////
          ...
          // blade0 angle
          buffer_int16 = (int16_t)(-mod180((current_angle_rd-motor_angle_offset+rpy[2])*rad_to_deg-yaw_ref)*32768.0/180.0); // we put the data in the int16 buffer
          ...
          buffer_int16 = (int16_t)((-motor_speed_rps*rad_to_deg)*32768.0/2000.0);

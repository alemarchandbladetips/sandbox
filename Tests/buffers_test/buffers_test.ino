...
#define DELAY_SAMPLE 35         // Delay between IMU and GPS in samples (100Hz = 0.35s)
...
float K_pos = 0.5;                            // correction gain position
float K_speed = 0.5;                          // correction gain speed
...
////////// reception of IMU data on serial ////////////////
  ...
  { // data available
    ...
    {
      time2 = micros();
      dt = (float)(time2 - time1)/1000000.0;
      time1 = time2;
...
//////////// decoding input serial data ////////////////////
          ...
          for(i=0;i<3;i++)
          {
            proper_acc[i] = proper_acc[i]*100; // conversion to cm/s2
          }
...
////////// KF : correction ////////////////
          ...
          { // gps correction is available
            ...
            get_in_buffer3(est_speed_cmps_buffer, &est_speed_cmps_buffer_index, DELAY_SAMPLE, 0, est_speed_cmps);
            get_in_buffer3(est_position_cm_buffer, &est_position_cm_buffer_index, DELAY_SAMPLE, 0, est_position_cm);
            ...
            { // replaying the prediction of the buffer to propagate correction to present time
              ...
              get_in_buffer3(proper_acc_buffer, &proper_acc_buffer_index, DELAY_SAMPLE, j, proper_acc_buffer);
          ...
          if (print_data) {
            ...
            Serial.print(" ");
            Serial.print(proper_acc[1]);
            Serial.print(" ");
            Serial.print(NED_coordinates[1]);
            Serial.print(" ");
            Serial.print(est_position_cm[1]);
            Serial.print(" ");
            Serial.print(NED_speed[1]);
            Serial.print(" ");
            Serial.print(est_speed_cmps[1]);
          }

          if(dt*1000>15 || dt*1000<5)
          {
            delay(5000);
          }

...
// Applying the command if new
  ...
  if (Serial.available() > IUM_PACKET_SIZE-1)
  { 
    ...
    if(x == PACKET_START)
    {
      if(print_data){ /*Serial.print(sinAngleA); Serial.print(" "); Serial.print(sinAngleB); Serial.print(" "); Serial.print(sinAngleC); Serial.print(" ");*/ Serial.println(time_counter2); }
      time_counter2 =0;
  ...
  // Computing command
        ...
        //if(imu_init == 1 || (accuracy_flags & 0x03) == 0x03)
        {
          ...
          u =  u_proportionel + u_integral + omega[2]/two_pi;
          /*
        ...
        //u=0;
        sin_amplitude = constrain(64+1.5*abs(u),0,SIN_APMLITUDE_MAX);

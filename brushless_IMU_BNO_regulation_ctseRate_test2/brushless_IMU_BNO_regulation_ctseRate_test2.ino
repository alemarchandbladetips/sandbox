...
// Applying the command if new
  ...
  { 
    ...
    if(x == PACKET_START)
    {
      ...
      //if(print_data){  Serial.println(micros()-t0); }
      t0 = micros();
      time_counter2 =0;
      ...
      //if(raw_data[IUM_PACKET_SIZE-1] == PACKET_STOP)
      {
        ...
        for(i=0;i<3;i++)
        {
          if(print_data){ Serial.print(rpy[i]*rad_to_deg); Serial.print(" "); }
        }
        if(print_data){ Serial.print(mod180(rpy[2]* rad_to_deg-yaw_ref)); Serial.print(" "); }
        // gyro data */
  ...
  // Computing command
        ...
        //if(imu_init == 1 || (accuracy_flags & 0x03) == 0x03)
        {
          ...
          u =  omega[2]/two_pi + u_proportionel;//u_proportionel;// + u_integral + omega[2]/two_pi;
          /*Serial.print(mod180(rpy[2]* rad_to_deg-yaw_ref)); Serial.print(" ");
          Serial.print(current_angle_rd*rad_to_deg); Serial.print(" ");
          Serial.print(normalized_angle); Serial.print(" ");
          Serial.println(u*two_pi);*/
          /*
          if(abs(mod180(rpy[2]* rad_to_deg-yaw_ref))<1 && imu_init==0)
          {
          ...
          //Serial.print(u_integral); Serial.print(" "); Serial.print(mod180(rpy[2]* rad_to_deg-yaw_ref)); Serial.print(" "); Serial.println(u);
        } 

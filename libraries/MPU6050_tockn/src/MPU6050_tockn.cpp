...
void MPU6050::begin(){
	Serial.println("=================");
	Serial.println("Configuring sensor registers");
	writeMPU6050(MPU6050_SMPLRT_DIV, 0x00);
	writeMPU6050(MPU6050_CONFIG, 0x00);
	writeMPU6050(MPU6050_GYRO_CONFIG, 0x18);
	writeMPU6050(MPU6050_ACCEL_CONFIG, 0x18);
...
void MPU6050::update(){
	...
	gyroX = ((float)rawGyroX) / 16.384;
	gyroY = ((float)rawGyroY) / 16.384;
	gyroZ = ((float)rawGyroZ) / 16.384;

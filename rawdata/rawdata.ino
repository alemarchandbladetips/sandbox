...
Serial.print(euler.x());Serial.print(" ");
  ...
  if(init_done==1 && (micros()-timer1>3000000))
  {
    init_done = 2;
    timer1 = micros();
    Serial.print("Redémarage ");
    bno.begin(0x08);
    Serial.print(micros()-timer1);Serial.print(" ");
...
//  Serial.print(offsets.mag_offset_z);Serial.println(" ");
